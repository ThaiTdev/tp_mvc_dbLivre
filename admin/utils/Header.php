		...
		<ul class="nav justify-content-center nav-pills" id="menu">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<a class="dropdown-item" href="?controller=livre&action=all_formNewBook">Entrer un nouveau livre</a>
				</div>
			</li>
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<a class="dropdown-item" href="?controller=fournisseur&action=all_formNewFournisseur">Entrer un nouveau fournisseur</a>
				</div>
			</li>
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<a class="dropdown-item" href="?controller=commander&action=all_recupeData">Passer une nouvelle commande</a>
				</div>
			</li>
		</ul>
	</div>
